chrome.extension.sendMessage({action: "get_setting"}, function(response) {
	if(response.script_function == "on") {
		var a=document.location.href;
		if(null!=document.getElementById("Cbo_LX"))
			document.getElementById("Cbo_LX").value="\u5b66\u751f";
		else if(-1!=a.indexOf("stdgl/xkgl/ptxk/Web_ptxk_Main.aspx"))//必修课选课界面
			document.getElementById("RtMod1_Lb_title").setAttribute("href","/stdgl/xkgl/ptxk/Web_zgd_ptxk_new.aspx"),//必修课选课
			document.getElementById("RtMod3_Lb_title").setAttribute("href","/stdgl/xkgl/ptxk/Web_zgd_ptxk_tbx.aspx");//必修课退补选
		else if(-1!=a.indexOf("stdgl/xkgl/zyxxk/Web_xsxxkc_main.aspx"))//限选课选课界面
			document.getElementById("RtMod1_Lb_title").setAttribute("href","/stdgl/xkgl/zyxxk/Web_xsxxkc_select.aspx"),//限选课选课
			document.getElementById("RtMod2_Lb_title").setAttribute("href","/stdgl/xkgl/zyxxk/web_xsxxkc_tbx.aspx"),//限选课退补选
			document.getElementById("Rtmod4_Lb_title").setAttribute("href","/stdgl/xkgl/zyxxk/web_xsxxkc_tbx_2.aspx");//限选课第二轮退补选
		else if(-1!=a.indexOf("/stdgl/xkgl/gxk/Web_GXK_Main.aspx"))//公选课选课界面，引导至志愿选择界面
			document.getElementById("RtMod1_Lb_title").setAttribute("href","/stdgl/xkgl/gxk/Web_gxk_zyselect2013.aspx");
			//document.getElementById("RtMod1_Lb_title").setAttribute("href","/stdgl/xkgl/gxk/Web_gxk_zyselect.aspx");
		else if(-1!=a.indexOf("/stdgl/stdgl_index.aspx") && document.getElementById("HEADER4_Lb_title").text == "体育课选课管理") {
			document.getElementById("HEADER4_Lb_title").setAttribute("href","/stdgl/xkgl/tyxk/web_std_tyktbx.aspx");
			//document.getElementById("HEADER4_Lb_title").setAttribute("href","javascript:tyktbx()");
			/*$('#HEADER4_Lb_title').removeAttr("href");
			$('#HEADER4_Lb_title').attr('onclick' ,"var data = {"+
				    '__EVENTTARGET: "'+$("input[name='__EVENTTARGET']").attr('value')+'",'+
				    '__EVENTARGUMENT: "'+$("input[name='__EVENTARGUMENT']").attr('value')+'",'+
				    '__VIEWSTATE: "'+$("input[name='__VIEWSTATE']").attr('value')+'",'+
				'};'+
				'var temp = document.createElement("form"); '       +
			    "temp.action = '/stdgl/xkgl/tyxk/web_std_tyktbx.aspx'; "       +
			    'temp.method = "post";  '      +
		...
		else if(-1!=a.indexOf("/stdgl/xkgl/gxk/Web_gxk_zyselect.aspx")) {//公选课选择志愿界面
			$("tr[bgcolor='#7691C7']").append('<td><font color="White" size="2">助手选择</font></td><td><font color="White" size="2">助手删除</font></td>');
			$("#DG_GXK_CX tbody tr:eq(1)").append('<td><font size="2"><a id="DG_GXK_TBX__ctl2_Linkbutton5" href="javascript:__doPostBack(\'DG_GXK_TBX$_ctl2$Linkbutton5\',\'\')">助手选择</a></font></td><td><font size="2"><a id="DG_GXK_TBX__ctl2_Linkbutton6" href="javascript:__doPostBack(\'DG_GXK_TBX$_ctl2$Linkbutton6\',\'\')">助手删除</a></font></td>');
			$("#DG_GXK_CX tbody tr:eq(2)").append('<td><font size="2"><a id="DG_GXK_TBX__ctl3_Linkbutton5" href="javascript:__doPostBack(\'DG_GXK_TBX$_ctl3$Linkbutton5\',\'\')">助手选择</a></font></td><td><font size="2"><a id="DG_GXK_TBX__ctl3_Linkbutton6" href="javascript:__doPostBack(\'DG_GXK_TBX$_ctl3$Linkbutton6\',\'\')">助手删除</a></font></td>');
		}
		else if(-1!=a.indexOf("/stdgl/xkgl/gxk/Web_gxk_zyselect2013.aspx")) {//公选课选择志愿界面
			$("tr[bgcolor='#7691C7']").append('<td><font color="White" size="2">助手选择</font></td><td><font color="White" size="2">助手删除</font></td>');
			$("#DG_GXK_CX tbody tr:eq(1)").append('<td><font size="2"><a id="DG_GXK_TBX__ctl2_Linkbutton5" href="javascript:__doPostBack(\'DG_GXK_TBX$_ctl2$Linkbutton5\',\'\')">助手选择</a></font></td><td><font size="2"><a id="DG_GXK_TBX__ctl2_Linkbutton6" href="javascript:__doPostBack(\'DG_GXK_TBX$_ctl2$Linkbutton6\',\'\')">助手删除</a></font></td>');
			$("#DG_GXK_CX tbody tr:eq(2)").append('<td><font size="2"><a id="DG_GXK_TBX__ctl3_Linkbutton5" href="javascript:__doPostBack(\'DG_GXK_TBX$_ctl3$Linkbutton5\',\'\')">助手选择</a></font></td><td><font size="2"><a id="DG_GXK_TBX__ctl3_Linkbutton6" href="javascript:__doPostBack(\'DG_GXK_TBX$_ctl3$Linkbutton6\',\'\')">助手删除</a></font></td>');
		}
		...
		else if(-1!=a.indexOf("stdgl/cxxt/Web_Std_XQKB.aspx")) {//查课表界面
			//document.getElementById("Cbo_Xueqi").value=response.class_term,
			//document.getElementById("Button2").click();
		}
		else if(-1!=a.indexOf("stdgl/cxxt/cjcx/Cjcx_Xsgrcj.aspx")) {//查成绩界面
